...
export const INITIALIZE_AUTH = createAction('[Auth] Initialize Auth');
export const LOAD_USER_FROM_STORAGE = createAction('[Auth] Load User From Storage', props<{user: UserType, token: string}>());
